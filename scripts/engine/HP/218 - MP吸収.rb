...
module ConvertAttack
  ...
  # Сообщения для актёров (урон)
  MA[0] = {
    :hp => "%s потерял %s на %s!",
    :mp => "%s потерял %s на %s!",
    :tp => "%s потерял %s на %s!"}
  
  # Сообщения для актёров (восстановление)
  MA[1] = {
    :hp => "%s восстановил %s на %s!",
    :mp => "%s восстановил %s на %s!",
    :tp => "%s получил %s на %s!"}
  
  # Сообщения для врагов (урон)
  ME[0] = {
    :hp => "%s потерял %s на %s!",
    :mp => "%s потерял %s на %s!",
    :tp => "%s потерял %s на %s!"}
  
  # Сообщения для врагов (восстановление)
  ME[1] = {
    :hp => "%s восстановил %s на %s!",
    :mp => "%s восстановил %s на %s!",
    :tp => "%s получил %s на %s!"}
